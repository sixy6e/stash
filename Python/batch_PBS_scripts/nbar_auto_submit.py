...
/home/547/jps547/job_submissions/nbar/head/ga-neo-landsat-processor/process.py --sequential --debug --work ${OUTPUT_ROOT}/work --process_level nbar --nbar-root ${OUTPUT_ROOT}/output --l1t %s
""" %(NBAR_out, L1T_scene)
