...
Authors: Roger Edberg (roger.edberg@ga.gov.au)
...
if __name__ == '__main__':
    ...
    class PQTester(unittest.TestCase):
        ...
        def setUp(self):
           ...
           #self.x = numpy.random.randint(0,2,(16,3,3))
           self.x = 1025
        ...
        def test_unpack(self):
            ...
            self.assertEqual(d['Topo_Shadow'], 0b0)
            self.assertEqual(d['Cloud'], 0b01)
        ...
        def test_pack(self):
            ...
            pq = pack(d)
            print ' Unpack Integer: ', bin(pq), pq
            print ' Bit Mask: ', bin(self.x), self.x
