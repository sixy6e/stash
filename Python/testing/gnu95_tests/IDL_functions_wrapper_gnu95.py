import numpy
import datetime
import _idl_histogram_gnu95

def IDL_Histogram(data, binsize=None, max=None, min=None, nbins=None, omax=None, omin=None, reverse_indices=None, locations=None):
    ...
    def hist_int(data, n, min, max, binsize, nbins, max_bin, ri):
        ...
        _idl_histogram_gnu95.idl_histogram.histogram_dfloat(data, hist, n, nbins_, min, max, max_bin, binsize)
    ...
    def ri_int(data, hist, nbins, n, ri_sz, min, max, max_bin, binsize):
        ...
        _idl_histogram_gnu95.idl_histogram.reverse_indices_int(data, hist, ri, nbins_, n, ri_sz, min, max, max_bin, binsize)
    ...
    def ri_long(data, hist, nbins, n, ri_sz, min, max, max_bin, binsize):
        ...
        _idl_histogram_gnu95.idl_histogram.reverse_indices_long(data, hist, ri, nbins_, n, ri_sz, min, max, max_bin, binsize)
    ...
    def ri_dlong(data, hist, nbins, n, ri_sz, min, max, max_bin, binsize):
        ...
        _idl_histogram_gnu95.idl_histogram.reverse_indices_dlong(data, hist, ri, nbins_, n, ri_sz, min, max, max_bin, binsize)
    ...
    def ri_float(data, hist, nbins, n, ri_sz, min, max, max_bin, binsize):
        ...
        _idl_histogram_gnu95.idl_histogram.reverse_indices_float(data, hist, ri, nbins_, n, ri_sz, min, max, max_bin, binsize)
    ...
    def ri_dfloat(data, hist, nbins, n, ri_sz, min, max, max_bin, binsize):
        ...
        _idl_histogram_gnu95.idl_histogram.reverse_indices_dfloat(data, hist, ri, nbins_, n, ri_sz, min, max, max_bin, binsize)
