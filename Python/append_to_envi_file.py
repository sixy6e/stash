...
def main(envi_file, hdf_file, scratch_space, ytiles):
    ...
    if (os.path.splitext(hdf_file)[1] == '.gz'):
        ...
        # then need to uncompress the data
    ...
    if (struct_byt_char == 'Error'):
        raise Exception('Error. Incompatable Data Type. Compatable ENVI Byte Order Values Are: 0, 1')
    ...
    for tile in tiles:
        ...
        # TODO Build gnudatalanguage as a Python module. This will provide access
