...
;which is retrieved via the envi query
;So have to open the available bands list at the start
;as once in PS mode windows can't be generated.


;dir = 'D:\Data\Imagery\Landsat\Landsat_5'
...
;basename = outdir + 'L5TM_thumbs_'
basename = outdir + 'Storage02_L5TM_thumbs_'
